...
#fancyss repo
# main_url="https://raw.githubusercontent.com/hq450/fancyss/master/fancyss_qca"
main_url="https://qcasoft.ddnsto.com/shadowsocks"
...
update_ss2(){
	...
	echo_date "历史版本下载地址：https://github.com/hq450/fancyss_history_package/tree/master/fancyss_qca"
