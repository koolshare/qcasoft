...
exit_install(){
	...
	echo_date "fancyss_qca支持机型/平台：https://github.com/hq450/fancyss#fancyss_qca"
	echo_date "退出安装！"
...
case $(uname -m) in
	armv7l)
		# cpu架构为armv7，机型为RT-AX89X得官改固件可以安装
...
dbus set softcenter_module_shadowsocks_description="fancyss_qca 科学上网 for RT-AX89X"
