			...
			if(ct_key.length == "44" && ct_key.myReplace("-", "").length == "39"){
				...
				require(['/res/layer/layer.js'], function(layer) {
					layer.confirm(msg, {
						...
						layer.close(index);
						location.href = "http://" + pay_server + ":" + pay_port + "/pay_cfe_qca.php?paytype=3&uuid=" + ct_key + "&mcode=" + dbus["cfetool_mcode"].replace(/\+/g, "-") + "&router=" + net_address;
						return true;
					});
				});
				E("cfetool_key").value = "";
...
function get_pay_server() {
	$.ajax({
		url: 'https://qcasoft.ddnsto.com/cfetool/config.json.js',
		type: 'GET',
		dataType: 'jsonp',
...
function open_buy() {
	...
	require(['/res/layer/layer.js'], function(layer) {
		layer.open({
			...
			btn: ['微信支付', '支付宝', '人工邮件购买'],
			btn1: function() {
				location.href = "http://" + pay_server + ":" + pay_port + "/pay_cfe_qca.php?paytype=1&mcode=" + dbus["cfetool_mcode"].replace(/\+/g, "-") + "&router=" + net_address;
			},
			btn2: function() {
				location.href = "http://" + pay_server + ":" + pay_port + "/pay_cfe_qca.php?paytype=2&mcode=" + dbus["cfetool_mcode"].replace(/\+/g, "-") + "&router=" + net_address;
			},
			btn3: function() {
	...
	require(['/res/layer/layer.js'], function(layer) {
		layer.open({
			...
			content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">\
				<b>CFE工具箱</b><br><br>\
				CFE工具箱是一款付费插件，支持qca-ipq806x平台的机器，详情：<a style="color:#e7bd16" target="_blank" href="https://github.com/koolshare/qcasoft#%E6%9C%BA%E5%9E%8B%E6%94%AF%E6%8C%81"><u>机型支持</u></a><br>\
										...
										<td bgcolor="#4D595D" colspan="3" valign="top">
											...
											<div id="activated_info" class="content_status" style="height:205px;top:200px">
												...
												<div style="margin-top:0px;margin-left:3%;width:97%;text-align:left;">
													<div id="a_info1" style="font-size:12px;color:#000;">1.如果激活码遗失，可以重装插件找回，或者发送机器码到：<a id="cfetool_a_mail" style="font-size:12px;color:#CC0000;" href="mailto:mjy211@gmail.com?subject=CFE工具箱插件购买&body=这是邮件的内容">mjy211@gmail.com</a>寻回。</div>
											...
											<div id="log_content" class="soft_setting_log">
												<textarea cols="63" rows="20" wrap="on" readonly="readonly" id="log_content_text" class="soft_setting_log1" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"></textarea>
											</div>
											<div id="cfetool_main" style="margin-top:10px;display: none;">
												<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable">
													...
													<tr>
														<th style="width:20%">CFE工具箱激活码</th>
														<td>
											...
											<div class="SimpleNote" id="message" style="display: none;">
												<li id="msg3" style="color:#00FFCC">对于非国行的RT-AX89X，其wifi发射功率很低，比如欧版的只有几十毫瓦，但是通过本工具修改为国行后可以获得1000毫瓦的功率！</li>
												<li id="msg1">本插件通过修改底层CFE来实现修改路由器国家地区，类似于PC修改BIOS；须知修改CFE有风险，由此带来的风险请自行承担！</li>
												<li id="msg2">华硕通过地区代码来限制固件功能，如wifi选区澳大利亚，中文语言等，通过改CFE将路由器改为国区后这些功能将不会再受到限制。</li>
												<li id="msg4">修改完成后，卸载本插件、重置路由器、升级固件、刷三方固件/原厂固件等操作，只要不损坏CFE分区，机器均会保持国行状态。</li>
											</div>
										</td>
									</tr>
								</table>
